...
int main()
{
    ...
    char TempArr[3][3]= {'O','O','O','O','O','O','O','O','O',};
    ...
    void R_flip()
    {
        for(int i=0; i<3; i++)
        {
            ...
            TempArr[0][i]=RB[2-i][0];
            TempArr[1][i]=RB[2-i][1];
            TempArr[2][i]=RB[2-i][2];
    ...
    void L_flip()
    {
        for(int i=0; i<3; i++)
        {
            ...
            TempArr[0][i]=RB[5-i][0];
            TempArr[1][i]=RB[5-i][1];
            TempArr[2][i]=RB[5-i][2];
